...
def delete_account():
    ...
    db.session.commit()
    return jsonify({"msg": f"User '{current_user}' deleted successfully"}), 200
...
def account_deletion_page():
    return render_template('account_deletion.html'), 200
...
if __name__ == '__main__':
    ...
    serve(logged_app, host='0.0.0.0', port=5000)
